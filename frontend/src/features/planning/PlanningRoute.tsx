...
import type { VisualRegistryContribution } from "../../module-ui/registry/contributionAdapter";
...
export function PlanningRoute({ contribution, deprecated = false }: { contribution: VisualRegistryContribution; deprecated?: boolean }) {
