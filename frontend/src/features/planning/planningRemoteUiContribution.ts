...
export const planningRemoteUiContribution: ModuleUiContribution = {
  ...
  routes: [
    { routeId: "planning.home", moduleId: "planning", capabilityId: "planning.plans", pathTemplate: base, organizationScope: "required", screenId: "planning.home", status: "active", permission: "planning.plans.read", breadcrumb: { labelKey: "planning.breadcrumb.home" } },
    { routeId: "planning.plans.list", moduleId: "planning", capabilityId: "planning.plans", pathTemplate: route("/plans"), organizationScope: "required", screenId: "planning.plans.list", status: "active", permission: "planning.plans.read", breadcrumb: { labelKey: "planning.breadcrumb.list", parentRouteId: "planning.home" } },
    { routeId: "planning.plans.create", moduleId: "planning", capabilityId: "planning.plans", pathTemplate: route("/plans/create"), organizationScope: "required", screenId: "planning.plans.create", status: "active", permission: "planning.plans.manage", breadcrumb: { labelKey: "planning.breadcrumb.create", parentRouteId: "planning.plans.list" } },
    { routeId: "planning.plans.detail", moduleId: "planning", capabilityId: "planning.plans", pathTemplate: route("/plans/:planId"), organizationScope: "required", screenId: "planning.plans.detail", status: "active", permission: "planning.plans.read", breadcrumb: { labelKey: "planning.breadcrumb.detail", parentRouteId: "planning.plans.list" } },
    { routeId: "planning.plans.edit", moduleId: "planning", capabilityId: "planning.plans", pathTemplate: route("/plans/:planId/edit"), organizationScope: "required", screenId: "planning.plans.edit", status: "active", permission: "planning.plans.manage", breadcrumb: { labelKey: "planning.breadcrumb.edit", parentRouteId: "planning.plans.detail" } },
    { routeId: "planning.profile", moduleId: "planning", capabilityId: "planning.profile", pathTemplate: route("/profile"), organizationScope: "required", screenId: "planning.profile", status: "active", permission: "planning.profile.read", breadcrumb: { labelKey: "planning.breadcrumb.profile", parentRouteId: "planning.home" } },
  ],
  screens: [
