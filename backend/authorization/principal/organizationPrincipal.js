...
async function buildOrganizationPrincipal({claims={},session,tenantContext,routeOrganizationId,resourceOrganizationId,permissionId,rolePotentialVersion,principalType='user',membershipBindingSource='logto_claim',surface='organization',providers={},supportedVersions=[AUTHZ_CONTRACT_VERSION]}={}){
