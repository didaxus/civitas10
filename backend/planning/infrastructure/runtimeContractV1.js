...
const paths=Object.freeze({ createPlan:'/private/planning-runtime/v1/plans', listPlans:'/private/planning-runtime/v1/plans:list', readPlan:'/private/planning-runtime/v1/plans:read', updatePlan:'/private/planning-runtime/v1/plans:update', readProfile:'/private/planning-runtime/v1/profile:read', replaceProfile:'/private/planning-runtime/v1/profile:replace' });
...
function fromWireResponse(useCase, body){ if(!body || body.schemaVersion!==CONTRACT_VERSION) throw new Error('planning runtime response schema mismatch'); if(useCase==='listPlans') return pageDto(body.result); if(useCase==='readProfile'||useCase==='replaceProfile') return profileDto(body.result); return planDto(body.result); }
