...
function createPlanningRouter({ planningRemoteApplicationPort, availabilityResolver, authorizationProviders, authorizationResourceResolver, authorizationRegistry, productionHandoffService, productionHandoffOperations } = {}) {
