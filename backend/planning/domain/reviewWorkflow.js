...
const workflow = Object.freeze({
  assign(state, input) { if (state.status !== REVIEW_STATUS.DRAFT && state.status !== REVIEW_STATUS.CHANGES_REQUESTED) throw new ReviewWorkflowError('plan_not_assignable'); return evolve(state, REVIEW_EVENTS.ASSIGNED, input); },
