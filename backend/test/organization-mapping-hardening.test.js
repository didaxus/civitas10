...
const {mapPreview,mapPublication,mapEvaluation}=require("../organization-mapping/repository");
...
test("projections reject unknown, orphan, cyclic and multiple-root structures",()=>{
  ...
  assert.throws(()=>buildPrimaryScopeTree({nodes:[{id:"a"},{id:"b"}],edges:[]}),/mapping_structure_root_count_invalid/);
});
