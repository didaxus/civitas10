...
const hashInputs = {
  ...
  backend_routes_actions_services: ['backend/planning/application/remotePort.js','backend/planning/application/services.js','backend/planning/presentation/routes.js','backend/planning/presentation/problemMapper.js','backend/planning/infrastructure/transportAdapter.js','backend/services/moduleAvailabilityResolver.js','backend/services/moduleControlPlane.js'],
  frontend_routes_actions_screens: ['frontend/src/navigation/route-catalog.ts','frontend/src/navigation/route-builders.ts','frontend/src/authorization/registry/define-actions.ts','frontend/src/module-ui/loader/fallbackStates.ts','frontend/src/module-ui/loader/ModuleUiErrorBoundary.tsx','frontend/src/features/planning/PlanningRemote.tsx','frontend/src/features/planning/planningApi.ts','frontend/src/features/planning/planningRemoteUiContribution.ts'],
  planning_events: ['contracts/integration/integration-event-registry.json','contracts/integration/integration-event-v1.schema.json','docs/architecture/module-event-contracts.md','contracts/events/planning/schemas/planning-plan-created-v1.schema.json','contracts/events/planning/schemas/planning-profile-updated-v1.schema.json']
};
