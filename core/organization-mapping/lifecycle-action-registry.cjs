...
const organizationMappingLifecycleActions = Object.freeze([
  ...
  action("organizationModel.readDraft", "org.orgmodel_draft.read", { method: "GET", endpoint: "/o/{organizationId}/organization-model/drafts/active" }),
  ...
  action("organizationModel.readSensitiveMappingEvidence", "org.orgmodel_evidence.read", { method: "GET", endpoint: "/o/{organizationId}/organization-model/evaluations/{evaluationId}/evidence", evidenceClassification: "sensitive-external-facts", allowedUiTreatment: "redacted-by-default", riskClassification: "high", auditRequirement: "who-what-when-why", reasonRequirement: "required" }),
  ...
  action("organizationModel.reconcileUpstream", "org.orgmodel.reconcile", { method: "GET", endpoint: "/o/{organizationId}/organization-model/reconciliation", evidenceClassification: "external-facts", riskClassification: "elevated", auditRequirement: "reconciliation-summary", idempotencyRequirement: "required" }),
